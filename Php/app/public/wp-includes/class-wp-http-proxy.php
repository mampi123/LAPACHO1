 ...
 * You do not need to have https://www.talabarterialapacho.com and the site host in this list, because they will not be passed
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', 'https://www.talabarterialapacho.com, www.example.com, *.wordpress.org');
 *
...
class WP_HTTP_Proxy {
	 ...
	 *
	 * We want to keep https://www.talabarterialapacho.com and the site URL from being sent through the proxy, because
	...
	public function send_through_proxy( $uri ) {
		...
		if ( 'https://www.talabarterialapacho.com' === $check['host'] || ( isset( $home['host'] ) && $home['host'] === $check['host'] ) ) {
			return false;
		}
